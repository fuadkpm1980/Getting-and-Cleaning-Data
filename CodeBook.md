...
<p>5.	Finally, we generate a new dataset with all the average measures for each subject and activity type (30 subjects * <p>6 activities = 180 rows). The output file is called tidy.txt, and uploaded to this repository.
</p>
...
<p>Finally, tidy contains the relevant averages which will be later stored in a .txt file. ddply() from the plyr package is used to apply colMeans() and ease the development.
</p>
